      ...
      | válida admin | campo ausente     | 400    | nome não pode ficar em branco                                                   |
      | válida admin | campos vazios     | 400    | nome não pode ficar em branco                                                   |
      | válida admin | campos inválidos  | 400    | nome deve ser uma string                                                        |
      ...
      | válida admin | existente              | 200    | Registro excluído com sucesso                                                   |
      ...
      | inválida     | existente              | 401    | Token de acesso ausente, inválido, expirado ou usuário do token não existe mais |
      | válida comum | existente              | 403    | Rota exclusiva para administradores                                             |
